// React Bits <HoldButton />. https://reactbits.dev
// Kept dependency-free so the destructive confirmation works with pointer and
// keyboard input without pulling more code into the owner flow.
...
export default function HoldButton({
  ...
  useEffect(() => {
    ...
    return () => {
      clearTimeout(timerHandles.complete);
      clearTimeout(timerHandles.reset);
      cancelAnimationFrame(motionState.raf);
    };
  }, []);
